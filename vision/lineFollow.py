...
while(cap.isOpened()):
	...
	#	ret, thresh = cv2.threshold(gray, 215, 255, cv2.THRESH_BINARY)
		...
		#	if x < xoff:
			#	print("X1 not aligned")
			
			#if x+w > intw-xoff:
			#	print("X2 not aligned")


			cv2.line(image,(xoff,0),(xoff,yoff),(0,0,255),9)
			cv2.line(image,(intw - xoff,0),(intw-xoff,yoff),(0,0,255),9)
